...
function publicStageForHistoryEntry(entry = {}) {
    return entry.display_stage || entry.user_stage || entry.public_stage || "";
}
function stageDetailForHistoryEntry(entry = {}) {
    return entry.stage_detail || entry.detail || "";
}
export function stageHistoryDisplay(entry = {}) {
...
export function resolveStageHistoryDuration(entry, job, { finishedAtFallback = "", now = null, } = {}) {
