...
- `paddle_ocr_api/`：RetainPDF 自己的 OCR adapter 文档
- `mineru_api/`：MinerU 官方接口参考

如果你要改 RetainPDF 主链的 OCR 接入，优先看 [paddle_ocr_api/README.md](../../core/paddle_ocr_api/README.md) 和 [Rust API 文档](../../core/rust_api/README.md)。
