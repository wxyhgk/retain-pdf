...
from retainpdf_pipeline.translate.core.ocr.json_extractor import get_pages
from retainpdf_pipeline.translate.services.policy.rule_profiles import DEFAULT_RULE_PROFILE_NAME
from retainpdf_pipeline.translate.services.policy.rule_profiles import build_rule_profile_context
...
def build_book_translation_policy_config(
    *,
    ...
    if infer_domain and source_pdf_path is not None:
        from retainpdf_pipeline.translate.llm.domain_context import infer_domain_context
