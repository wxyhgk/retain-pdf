...
from retainpdf_pipeline.translate.core.ocr.normalized_reader import block_class
from retainpdf_pipeline.translate.core.ocr.normalized_reader import is_normalized_document
