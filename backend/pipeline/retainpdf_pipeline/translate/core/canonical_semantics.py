...
# Duplicated from retainpdf_pipeline.ocr.document_schema.canonical_semantics
# (stage-decouple: file-contract duplicate; do not re-add cross-stage import).

from dataclasses import asdict, dataclass

from retainpdf_pipeline.translate.core.classification import (
    derive_block_class,
    resolve_block_class,
    resolve_content_kind,
)
from retainpdf_pipeline.translate.core.vocabulary import (
    BLOCK_CLASSES,
    CONTENT_KINDS,
)
