...
from retainpdf_pipeline.render.source.cleanup.layer_items import bbox_text_strip_rects
from retainpdf_pipeline.render.source.cleanup.layer_items import visual_cover_rects
