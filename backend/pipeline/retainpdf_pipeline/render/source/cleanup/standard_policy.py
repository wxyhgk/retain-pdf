...
from retainpdf_pipeline.render.layout.inline_content.complexity import item_has_complex_inline_math
from retainpdf_pipeline.render.policy import build_cleanup_item_plan
from retainpdf_pipeline.render.source.cleanup.standard_thresholds import ITEM_REMOVABLE_RECTS_FAST_COVER_THRESHOLD
from retainpdf_pipeline.render.source.cleanup.standard_thresholds import PAGE_AVG_REMOVABLE_RECTS_FAST_COVER_THRESHOLD
from retainpdf_pipeline.render.source.cleanup.standard_thresholds import PAGE_ITEM_REMOVABLE_RECTS_FAST_COVER_COUNT
from retainpdf_pipeline.render.source.cleanup.standard_thresholds import PAGE_REMOVABLE_RECTS_FAST_COVER_THRESHOLD
