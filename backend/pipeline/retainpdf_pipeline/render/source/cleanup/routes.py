...
from retainpdf_pipeline.render.source.background.fill import apply_prepared_background_covers
from retainpdf_pipeline.render.source.background.fill import prepare_background_covers
from retainpdf_pipeline.render.source.cleanup.auto import apply_auto_redaction as _apply_auto_redaction
from retainpdf_pipeline.render.source.cleanup.cover_only import apply_cover_only_count_redaction as _apply_cover_only_count_redaction
from retainpdf_pipeline.render.source.cleanup.image_page import apply_image_page_redaction as _apply_image_page_redaction
from retainpdf_pipeline.render.source.cleanup.math_intrusion import page_has_intrusive_math_protection
from retainpdf_pipeline.render.source.cleanup.math_spans import collect_page_math_protection_rects
from retainpdf_pipeline.render.source.cleanup.math_spans import collect_page_non_math_span_heights
from retainpdf_pipeline.render.source.cleanup.route_context import RedactionRouteContext
from retainpdf_pipeline.render.source.cleanup.route_context import build_redaction_route_context
from retainpdf_pipeline.render.source.cleanup.route_decider import decide_redaction_execution
from retainpdf_pipeline.render.source.cleanup.standard import apply_standard_redaction
from retainpdf_pipeline.render.source.cleanup.strategy import resolve_redaction_route
from retainpdf_pipeline.render.source.cleanup.text_matching import item_removable_text_rects
from retainpdf_pipeline.render.source.cleanup.valid_items import iter_valid_redaction_items
from retainpdf_pipeline.render.source.cleanup.vector_heavy import apply_vector_heavy_redaction as _apply_vector_heavy_redaction
from retainpdf_pipeline.render.source.cleanup.visual_cover_execution import apply_visual_cover_redaction
