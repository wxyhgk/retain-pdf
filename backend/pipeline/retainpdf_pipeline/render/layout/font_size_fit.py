...
from retainpdf_pipeline.render.layout.font_roles import is_local_textual_item
from retainpdf_pipeline.render.layout.typography.measurement import clamp
