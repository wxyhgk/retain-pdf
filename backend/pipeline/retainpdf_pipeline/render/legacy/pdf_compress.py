...
from retainpdf_pipeline.render.source.compression.analysis import source_pdf_has_vector_graphics
...
from retainpdf_pipeline.render.source.compression.pdf_copy import compress_pdf_images_only
