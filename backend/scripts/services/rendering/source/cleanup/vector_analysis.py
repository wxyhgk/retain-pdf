...
from services.rendering.source.cleanup.config import HEAVY_VECTOR_PAGE_DRAWINGS_THRESHOLD
...
from services.rendering.source.cleanup.config import VECTOR_HEAVY_PAGE_DRAWINGS_THRESHOLD
