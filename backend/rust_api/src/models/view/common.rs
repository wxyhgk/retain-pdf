...
pub struct ListJobsQuery {
    ...
    #[serde(default)]
    pub q: Option<String>,
    /// Phân cách bằng dấu phẩy job_id Danh sách trắng(TÃ¹y chá»n)。Khi thư mục danh mục được mở rộng, hãy sử dụng nó để
    /// `GET /api/v1/documents?collection_id=` Đã giải quyết active_job_id tập hợp
    /// Chuyển đổi sang dữ liệu thẻ thư viện——Hành vi không truyền tải hoàn toàn phù hợp với hiện trạng。
    #[serde(default)]
